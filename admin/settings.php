	...
	<div class="wrap">
		...
		<div id="sops-settings">
			...
			<form method="post" action="options.php">
				...
				<table class="form-table"><tbody>
					...
					<tr valign="top">
						<th scope="row">
							<label for="sops-slugglue"><?php _e( 'Slug Glue', 'so-pinyin-slugs' ); ?></label>
						</th>

						<td>
							<input name="sops_options[slug_glue]" type="text" id="slug_glue" value="<?php echo $options['slug_glue']; ?>" />
							<p class="description"><?php _e( 'By default the slug glue is set to empty string. If you want to change it, you can do that here.', 'so-pinyin-slugs' ); ?></p>
							<input type="hidden" name="action" value="update" />
							<input type="hidden" name="page_options" value="<?php echo $options['slug_glue']; ?>" />
						</td>
					</tr>
		...
		<div class="author postbox">
			...
			<div class="inside">
				...
				<ul>
						<li><a href="https://bohanintl.com/" target="_blank" title="BHI Consulting"><?php _e( 'BHI Consulting', 'so-pinyin-slugs' ); ?></a></li>
						...
						<li><a href="https://wpti.ps/" target="_blank" title="WP TIPS"><?php _e( 'WP Tips', 'so-pinyin-slugs' ); ?></a></li>
